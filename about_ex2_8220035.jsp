    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="about_ex2_8220035.jsp">About</a></li>
          <% 
        ...
        <ul class="nav navbar-nav navbar-right">
          <%
            if (session.getAttribute("userObj2024") == null) {
          %>
            <li><a href="register_ex2_8220035.jsp">Register</a></li>
            <li><a href="login_ex2_8220035.jsp">Sign in</a></li>
          <% 
            } else { 
              User user = (User) session.getAttribute("userObj2024");
          %>
            <li><p class="navbar-text">Signed in as <%= user.getUsername() %></p></li>
            <li><a href="logout_ex2_8220035.jsp">Sign out</a></li>
          <% 
            } 
          %>
        </ul>
